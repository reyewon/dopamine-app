/**
 * GET /api/scripts/pixieset-scraper
 * Serves the Pixieset invoice scraper as a JS file.
 * This exists because Cloudflare Pages + @cloudflare/next-on-pages
 * routes public/ files through the worker, returning HTML instead of JS.
 */
