        ...
        <Card className="flex flex-col h-full rounded-3xl overflow-hidden shadow-lg border-border">
            <CardHeader className="bg-primary text-primary-foreground p-6">
                <div className="flex justify-between items-start">
                    <div>
                        <CardTitle className="text-2xl font-bold pr-4">{shoot.title}</CardTitle>
            ...
            <CardContent className="flex-1 space-y-4 p-6 bg-card">
                ...
                {/* Date & Weather */}
                 <div className="flex flex-col gap-2 pt-2">
                    {shoot.shootDate && <p className="flex items-center gap-2 font-bold text-foreground text-md"><Calendar size={14} /> {format(new Date(shoot.shootDate), 'PPP')}</p>}
            ...
            <CardFooter className="flex-col items-start gap-4 p-6 bg-card">
                ...
                <div className="w-full space-y-4">
                    ...
                    <div className="space-y-2">
                        <p className="text-[11px] font-bold opacity-50 uppercase tracking-wider">Progress</p>
